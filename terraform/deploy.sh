...
# GOOS=linux go build -o ./../build/microservice/SlackSlashCommand/main ./../src/microservice/SlackSlashCommand/main.go
...
# GOOS=linux go build -o ./../build/microservice/SlackDynamicDataSource/main ./../src/microservice/SlackDynamicDataSource/main.go
...
# GOOS=linux go build -o ./../build/microservice/ApiGatewayHandler/main ./../src/microservice/ApiGatewayHandler/main.go
...
# GOOS=linux go build -o ./../build/microservice/ServiceInvoker/main ./../src/microservice/ServiceInvoker/main.go
...
# GOOS=linux go build -o ./../build/microservice/ServiceMetadata/main ./../src/microservice/ServiceMetadata/main.go
...
GOOS=linux go build -o ./../build/microservice/Logger/main ./../src/microservice/Logger/main.go
...
GOOS=linux go build -o ./../build/microservice/Scheduler/main ./../src/microservice/Scheduler/main.go
